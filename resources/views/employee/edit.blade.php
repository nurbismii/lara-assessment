...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-lg-12 mb-3">
      <div class="card">
        <div class="card-body">
          <form action="{{route('employee.update', $employee->id)}}" method="post" enctype="application/x-www-form-urlencoded">
            @csrf
            {{method_field('patch')}}
            <div class="form-row">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="departement" value="{{$employee->departement}}">
            </div>
            <div class="form-group">
